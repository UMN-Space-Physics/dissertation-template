...
This template is different in a few ways from the official UMN template: 
copyright options now include CC-BY and CC-BY-SA, pages are always numbered at
the bottom, etc. 

The template remains consistent with the official style requirements, which can
be found here:
